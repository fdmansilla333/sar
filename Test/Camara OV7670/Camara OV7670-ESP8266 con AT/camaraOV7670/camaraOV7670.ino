...
void arduinoUnoInut(void) {
  ...
  * This will be on pin 11*/
  ...
  TWSR &= ~3;//disable prescaler for TWI (Two wire status register) Informa el estado de las acciones TWI
...
void setup(){
    ...
    //sendData("AT+RST\r\n", 0); //Reseteo de modulo
    //sendData("AT+CIOBAUD=115200\r\n", 0); // Configuro la velocidad en baudios
    //Serial.println("-------FIN CONFIG VELNUEVA------");
    //ESP.begin(VELNUEVA);  
    //sendData("AT+CIPSTART=\"UDP\",\"192.168.4.2\",50494",0); //Establecer conexion con el IP/Puerto
    ...
    ESP.begin(115200); //Setea la velocidad en la que va a trabajar el modulo
